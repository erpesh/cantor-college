...
<head>
  ...
  <title>For Staff | Cantor College</title>
...
<body>
  ...
  <div class="mainContainer">
    <main>
      <div class="banner">
        <div class="bannerImage forStaffImage" style="background-size: cover">
          <img src="images/forStaff.webp" style="visibility: hidden" />
          <h1>For Staff</h1>
        </div>
      </div>
        ...
        <ul class="nonDecor itemsMargin">
          <li>
            ...
            <p>Cantor College recently hosted the Software Engineering student of the year awards. Shortlisted
              candidates from around the country attended the one day event.</p>
          </li>
          <li>
